...
export const DEFAULT = {
  [namespace]: (config: ActionheroConfigInterface) => {
    return {
      ...
      // this will slow down the performance of actionhero, and if you need this functionality, it is recommended that you
      // do this upstream with nginx or your load balancer
      compress: false,
